...
DATASET_KEY = "ed811_m22"
DMS_CONFIG_PATH = REPO_ROOT / "conf" / "data" / "dms" / "default.yaml"
LOCAL_RUNTIME_DIR = REPO_ROOT / "data" / "processed" / "stats_d811"
LOCAL_RAW_FILENAME = "ED811_M22_enrichment_full.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=REPO_ROOT / "data" / "raw" / "ED811_M22_enrichment_full.csv",
...
def plot_train_entropy_heatmap(plots_dir: Path) -> Path:
    ...
    output_path = plots_dir / "ED811_train_temp_entropy_heatmap.png"
    ...
    ax.set_title("ED811 train split: position-wise entropy")
...
def plot_m22_enrichment_distribution(df: pd.DataFrame, output_path: Path) -> bool:
    ...
    plt.title("ED811 Distribution of M22_binding_enrichment_adj", fontsize=20)
