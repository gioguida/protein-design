...
LOCAL_RUNTIME_DIR = REPO_ROOT / "data" / "processed" / "stats_d5"
LOCAL_RAW_FILENAME = "ED5_M22_binding_enrichment.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=REPO_ROOT / "data" / "raw" / "ED5_M22_binding_enrichment.csv",
...
def plot_train_entropy_heatmap(plots_dir: Path) -> Path:
    ...
    output_path = plots_dir / "ED5_train_temp_entropy_heatmap.png"
    ...
    ax.set_title("ED5 train split: position-wise entropy")
...
def plot_m22_enrichment_distribution(df: pd.DataFrame, output_path: Path) -> bool:
    ...
    plt.title("ED5 Distribution of M22_binding_enrichment_adj", fontsize=20)
