...
def build_or_load_cluster_split_membership(
    *,
    ...
    expected_meta = {
        "method": "hamming_connected_components_lte_1_all_num_mut",
    ...
    if "num_mut" in clean_df.columns:
        clean_df["num_mut"] = pd.to_numeric(clean_df["num_mut"], errors="coerce")

    clean_df["cluster_id"] = _compute_cluster_ids_hamming_lte_one(clean_df["aa"].tolist())
    cluster_stats = (
