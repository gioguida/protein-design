...
SBATCH_SCRIPT_PATH="bash_scripts/utils/run_full_analysis.sh"
...
ANALYSIS_CONFIG="${ANALYSIS_CONFIG:-conf/analysis/full_analysis.yaml}"
DRY_RUN="${DRY_RUN:-0}"
...
uv run python scripts/analysis/run_full_analysis_from_config.py "${ARGS[@]}"
